...
public class AddressBook{
    ...
    void setContact(){
        Contact person = new Contact(index, bookName, bookName, bookName, bookName, bookName, bookName, bookName, bookName);
...
//        addContact();
    ...
    private void handleSortChoice(int option) {
...
//    }
    void addContact(){
        Contact obj1 = new Contact(index, bookName, bookName, bookName, bookName, bookName, bookName, bookName, bookName);
        Contact obj2 = new Contact(index, bookName, bookName, bookName, bookName, bookName, bookName, bookName, bookName);
        Contact obj3 = new Contact(index, bookName, bookName, bookName, bookName, bookName, bookName, bookName, bookName);
        Contact obj4 = new Contact(index, bookName, bookName, bookName, bookName, bookName, bookName, bookName, bookName);
        Contact obj5 = new Contact(index, bookName, bookName, bookName, bookName, bookName, bookName, bookName, bookName);
        Contact obj6 = new Contact(index, bookName, bookName, bookName, bookName, bookName, bookName, bookName, bookName);
        entry.add(obj1);
        entry.add(obj2);
        entry.add(obj3);
        entry.add(obj4);
